...
from cyberdefense.rules import evaluate_rules
...
def main() -> int:
    ...
    findings = evaluate_rules(collection)

    report = render_json(findings, collection.coverage) if args.json else render_text(findings, collection.coverage)
